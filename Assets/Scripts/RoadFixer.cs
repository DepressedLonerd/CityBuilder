...
public class RoadFixer : MonoBehaviour
{
    ...
    public void FixRoadAtPosition(PlacementManager placementManager, Vector3Int temporaryPosition)
    {
        ...
        {
            if (CreareStraightRoad(placementManager, result, temporaryPosition))
                return;
    ...
    private bool CreareStraightRoad(PlacementManager placementManager, CellType[] result, Vector3Int temporaryPosition)
    {
